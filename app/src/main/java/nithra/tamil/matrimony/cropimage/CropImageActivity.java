...
package nithra.tamil.matrimony.cropimage;
...
import nithra.tamil.matrimony.R;
import nithra.tamil.matrimony.Registration_Four;
...
public class CropImageActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        DB = openOrCreateDatabase("RESUME_MULTI_LANGUAGE", 0, null);
    ...
    protected void setResult(Uri uri, Exception error, int sampleSize) {
        ...
        File fil = new File(root.getAbsolutePath()
                    + "/.Nithra_Matrimony/" + uniqueId + "_image.jpg");
            savefile(uri, fil);
            if(CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE==200){
                if(Registration_Four.img_path1.size()!=0){
                    new File(Registration_Four.img_path1.get(0)).delete();
                }
                Registration_Four.img_path1.clear();
                Registration_Four.img_path1.add(fil.getPath());
            }
        if(CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE==201){
            if(Registration_Four.img_path2.size()!=0){
                new File(Registration_Four.img_path2.get(0)).delete();
            }
            Registration_Four.img_path2.clear();
            Registration_Four.img_path2.add(fil.getPath());
        }
        if(CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE==202){
            if(Registration_Four.img_path3.size()!=0){
                new File(Registration_Four.img_path3.get(0)).delete();
            }
            Registration_Four.img_path3.clear();
            Registration_Four.img_path3.add(fil.getPath());
        }
        if(CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE==203){
            if(Registration_Four.img_path4.size()!=0){
                new File(Registration_Four.img_path4.get(0)).delete();
            }
            Registration_Four.img_path4.clear();
            Registration_Four.img_path4.add(fil.getPath());
        }
    ...
    public void savefile(Uri sourceuri, File mydir) {
        String sourceFilename = sourceuri.getPath();


        // final File to = new File(mydir, fname);

        String destinationFilename = mydir.getAbsolutePath();
